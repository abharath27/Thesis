...
When the user selects one of the critique strings, the product corresponding to the selected string is made as the reference product in the next cycle and user's preference model is updated based on this selection.
...
%\begin{figure}[tbh]
%  \centering
%  \subfloat[PC Dataset]{\includegraphics[width=.45\textwidth]{figures-bharath/pc_results}\label{fig:pc_results}} \hspace{.05\textwidth}
%  \subfloat[Apartment Dataset]{\includegraphics[width=.45\textwidth]{figures-bharath/apartment_results}\label{fig:apartment_results}}
